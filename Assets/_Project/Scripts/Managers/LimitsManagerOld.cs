...
namespace redd096
{
    ...
    [CustomEditor(typeof(LimitsManagerOld))]
    public class LimitsManagerEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button("Regen Limits"))
            {
                ...
                ((LimitsManagerOld)target).RegenLimits();
            ...
            if (GUILayout.Button("Destroy Limits"))
            {
                ...
                ((LimitsManagerOld)target).DestroyLimits();
    ...
    public class LimitsManagerOld : MonoBehaviour
    {
